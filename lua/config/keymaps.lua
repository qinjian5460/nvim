...
vim.keymap.set("n", "<leader>t", ":NvimTreeToggle<CR>:setlocal winhighlight=Normal:ActiveWindow<CR>", {noremap = true})
...
vim.keymap.set("n", "<leader>e", ":lua vim.diagnostic.open_float(nil, {focus=false})<CR>", {noremap = true})
vim.keymap.set("n", "<leader>w", ":Lspsaga term_toggle<CR>", {noremap = true})
vim.keymap.set("n", "<C-CR>", ":Lspsaga show_line_diagnostics<CR>", {noremap = true})
vim.keymap.set("n", "<leader>d", ":Lspsaga peek_definition<CR>", {noremap = true})
vim.keymap.set("n", "<leader>z", ":DapContinue<CR>", {noremap = true})
vim.keymap.set("n", "=", ":DapToggleBreakpoint<CR>", {noremap = ture})
